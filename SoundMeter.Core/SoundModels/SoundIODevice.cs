...
namespace SoundMeter.Core.Models
{
	public class SoundIODevice
	{
		...
		public static readonly SoundIOFormat Float32LE = BitConverter.IsLittleEndian ? SoundIOFormat.Float32LE : SoundIOFormat.Float32BE;
		public static readonly SoundIOFormat Float64LE = BitConverter.IsLittleEndian ? SoundIOFormat.Float64LE : SoundIOFormat.Float64BE;
